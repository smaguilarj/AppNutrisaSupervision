...
class NotificacionAdapter(private var myDataset: ArrayList<PushNotification>,val  listener: NotificationInterface) : RecyclerView.Adapter<NotificacionAdapter.ViewHolder>() {
    ...
    class ViewHolder(vista: View, listener: NotificationInterface): RecyclerView.ViewHolder(vista),View.OnClickListener {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val newNotification: PushNotification = myDataset[position]
