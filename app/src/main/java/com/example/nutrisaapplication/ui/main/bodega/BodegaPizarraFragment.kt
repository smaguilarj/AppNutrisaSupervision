...
class BodegaPizarraFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        imb_no20.setOnClickListener {tomaFoto(8)}
        ...
        buttonEnviar.setOnClickListener { navigation.navigate(R.id.action_bodegaPizarraFragment_to_planTrabajoFragment) }
    }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            when (requestCode) {
                1 -> {
                    img_question18.setImageURI(fileUri);respuesta="SI";pregunta=11
                    Log.d("respuesta","pregunta: $pregunta respuesta:$respuesta")
                }
                2 -> {
                    img_question19.setImageURI(fileUri);respuesta="SI";pregunta=12
                    Log.d("respuesta","pregunta: $pregunta respuesta:$respuesta")
                }
                3 -> {
                    img_question18.setImageURI(fileUri);respuesta="NO";pregunta=11
                    Log.d("respuesta","pregunta: $pregunta respuesta:$respuesta")
                }
                4-> {
                    img_question19.setImageURI(fileUri);respuesta="NO";pregunta=12
                    Log.d("respuesta","pregunta: $pregunta respuesta:$respuesta")
                }
                5 -> {
