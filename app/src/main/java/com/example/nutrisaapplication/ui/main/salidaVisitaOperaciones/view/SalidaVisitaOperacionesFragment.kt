package com.example.nutrisaapplication.ui.main.salidaVisitaOperaciones.view
...
class SalidaVisitaOperacionesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_salida_visita_operaciones, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btn_firma_evaluador.setOnClickListener {
            navigation.navigate(R.id.action_salidaVisitaOperacionesFragment_to_signatureFragment2)
        ...
        btn_salida_rapida.setOnClickListener {
            ...
            //navigation.navigate(R.id.action_salidaVisitaOperacionesFragment_to_visitToStoreFragment)
        }
    }
}